...
import org.broadinstitute.gatk.tools.walkers.compression.reducereads.ReduceReads.DownsampleStrategy
...
class RRead extends QScript {
  ...
  @Argument(shortName = "e",        required = false, fullName = "expand_intervals", doc = "Expand each target in input intervals by the specified number of bases. By default set to 50 bases.") protected var expandIntervals: Int = 50
