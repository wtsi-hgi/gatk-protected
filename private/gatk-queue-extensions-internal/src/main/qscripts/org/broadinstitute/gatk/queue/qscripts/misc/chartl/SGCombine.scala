...
import org.broadinstitute.gatk.utils.variantcontext.VariantContextUtils.GenotypeMergeType
import org.broadinstitute.gatk.queue.extensions.gatk.{TaggedFile, SelectVariants, CombineVariants}
