...
public class NA12878KnowledgeBaseTestBase extends BaseTest {
    private final static Logger logger = Logger.getLogger(NA12878KnowledgeBaseTestBase.class);
    ...
    protected static void initialSetup() {
        try {
            ...
            throw new SkipException("Couldn't read test VCF so skipping NA12878KB tests");
        }
    }
