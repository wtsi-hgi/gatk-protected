...
public class PoolCallerIntegrationTest extends WalkerTest {
    ...
    private void PC_LSV_Test(String args, String name, String model, String md5) {
        final String base = String.format("-T PoolCaller -R %s -I %s -L %s -reference %s -refsample %s -glm %s -ignoreLane -pnrm POOL",
    ...
    public void testBOTH_GGA_Pools() {
        PC_LSV_Test(String.format(" -maxAlleles 2 -sp 12 -gt_mode GENOTYPE_GIVEN_ALLELES -alleles %s",LSV_ALLELES),"LSV_BOTH_GGA","POOLBOTH","da85bf56eeafae31b5a269b4e19b5db6");
    }

    @Test
    public void testINDEL_GGA_Pools() {
        PC_LSV_Test(String.format(" -maxAlleles 1 -sp 12 -gt_mode GENOTYPE_GIVEN_ALLELES -alleles %s",LSV_ALLELES),"LSV_BOTH_GGA","POOLINDEL","d1339990291648495bfcf4404f051478");
    }

    @Test
    public void testMT_SNP_DISCOVERY_sp4() {
         PC_MT_Test(CEUTRIO_BAM, " -maxAlleles 1 -sp 4", "MT_SNP_DISCOVERY_sp4","060f06987a33f60433b0382cd7227140");
    }

    @Test
    public void testMT_SNP_GGA_sp10() {

        PC_MT_Test(CEUTRIO_BAM, String.format(" -maxAlleles 1 -sp 10 -gt_mode GENOTYPE_GIVEN_ALLELES -alleles %s",NA12891_CALLS), "MT_SNP_GGA_sp10", "df3ffc5cb76224ba152f543925eb3974");
    }
