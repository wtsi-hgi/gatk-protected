...
public class BQSRIntegrationTest extends WalkerTest {
    ...
    private final void testCC(CCTest test, String parallelism) {
        ...
        WalkerTestSpec spec = new WalkerTestSpec("-R " + b36KGReference +
                " -knownSites " + b36dbSNP129 +
                " -T BaseQualityScoreRecalibration" +
                " -I " + bam +
                (bam.equals(validationDataLocation + "NA12878.1kg.p2.chr1_10mb_11_mb.allTechs.bam") ? " -L 1:10,800,000-10,810,000" : " -L 1:10,000,000-10,200,000") +
                " -cov ReadGroupCovariate" +
                " -cov QualityScoreCovariate" +
                " -cov CycleCovariate" +
                " -cov DinucCovariate" +
                " --solid_recal_mode SET_Q_ZERO" +
                " -o %s" + parallelism, 1, // just one output file
                Arrays.asList(md5));
    ...
    public void testTableRecalibrator1(TRTest test) {
        ...
        if (paramsFile != null) {
            WalkerTestSpec spec = new WalkerTestSpec("-R " + b36KGReference +
                    ...
                    " -I " + bam +
                    (bam.equals(validationDataLocation + "NA12878.1kg.p2.chr1_10mb_11_mb.allTechs.bam") ? " -L 1:10,800,000-10,810,000" : " -L 1:10,100,000-10,300,000") +
                    " -o %s" +
                    " --no_pg_tag" +
                    " --solid_recal_mode SET_Q_ZERO" +
                    " -o " + paramsFile, 1, // just one output file
                    Arrays.asList(md5));
    ...
    public void testCountCovariatesUseOriginalQuals() {
        ...
        for (Map.Entry<String, String> entry : e.entrySet()) {
            ...
            WalkerTestSpec spec = new WalkerTestSpec("-R " + b36KGReference +
                    ...
                    " -OQ" +
                    " -o %s" +
                    " -knownSites " + b36dbSNP129, 1, // just one output file
                    Arrays.asList(md5));
