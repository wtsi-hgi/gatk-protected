 ...
 */
public class OriginalQualScoreHistogram extends ReadWalker<Boolean,Long> {
    ...
    public Boolean map(ReferenceContext ref, GATKSAMRecord read, RefMetaDataTracker metaDataTracker) {
