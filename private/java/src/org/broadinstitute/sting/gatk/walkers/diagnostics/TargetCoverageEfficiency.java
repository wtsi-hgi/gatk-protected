...
public class TargetCoverageEfficiency extends LocusWalker<Long, ArrayList<Long>> {
    ...
    public void initialize () {
        reportTable = new GATKReportTable("TargetCoverageEfficiency", "A table with the values per interval for: target coverage, average interval coverage and the ratio between the two.", 4);
