 ...
 */
public class RFAGenotypeLikelihoodsCalculationModel extends GenotypeLikelihoodsCalculationModel {
    ...
    public Allele getLikelihoods(RefMetaDataTracker tracker,
        ...
        // todo this -- morph the contexts into something the RFAGLCM likes to process (from the RFAWalker)

        return null;  // super broken
    }
    ...
    public Map<String,GenotypeLikelihoods> getLikelihoods(RefMetaDataTracker tracker, ReferenceContext ref, Map<String,BinaryFeatureAggregator> aggregators) {
