...
$import -callSetName CEUTrio_best_practices -assumedCallTruth TRUE_POSITIVE -howToTreatFilteredSites SUSPECT -howToTreatAC0 MARK_AS_NON_POLYMORPHIC -V $source/CEUTrio.HiSeq.WGS.b37.bestPractices.phased.b37.na12878.kbInterval.vcf
...
$import -callSetName 1000G_250sites_indelValidation_POLY -assumedCallTruth TRUE_POSITIVE -howToTreatFilteredSites SKIP -howToTreatAC0 SKIP -V $source/1000G.250sites.indelValidation.polymorphic.alleles.na12878.kbInterval.vcf
...
$import -callSetName 1000G_variousValidations -assumedCallTruth TRUE_POSITIVE -howToTreatFilteredSites SKIP -howToTreatAC0 SKIP -V $source/1000G.validationExperiments.polymorphic.b37.na12878.kbInterval.vcf
