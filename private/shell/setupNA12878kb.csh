...
$import -callSetName OMNI2.5Poly -assumedCallTruth TRUE_POSITIVE -howToTreatFilteredSites SKIP -howToTreatAC0 SKIP -V $source/Omni25_genotypes_2141_samples.b37.na12878.20.vcf
...
$import -callSetName CEUTrio_best_practices -assumedCallTruth TRUE_POSITIVE -howToTreatFilteredSites SUSPECT -howToTreatAC0 MARK_AS_NON_POLYMORPHIC -V $source/CEUTrio.HiSeq.WGS.b37.bestPractices.phased.b37.na12878.20.vcf
...
$import -callSetName HapMap3.3 -assumedCallTruth TRUE_POSITIVE -howToTreatFilteredSites SKIP -howToTreatAC0 SKIP -V $source/genotypes_r27_nr.b37_fwd.na12878.20.vcf
