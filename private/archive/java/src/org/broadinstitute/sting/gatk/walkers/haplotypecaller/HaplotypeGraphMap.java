...
/**
 * Information as to how a haplotype maps on an (assembly) graph.
 *
 * @author Valentin Ruano-Rubio &lt;valentin@broadinstitute.com&gt;
 */
public class HaplotypeGraphMap<V extends BaseVertex, E extends BaseEdge> extends KmerSequenceGraphMap<V,E> {

    protected Haplotype haplotype;

    public HaplotypeGraphMap(final KmerSearchableGraph<V, E> g, final Haplotype h) {
        super(g, new KmerSequence(h,g.getKmerSize()));
        haplotype =h;
    }
