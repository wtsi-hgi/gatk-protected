...
class LargeScaleValidationSiteSelector extends QScript {
  ...
  def script = {
    ...
    USnps.out = qscript.outputDir + "/"+"ALL.wgs.%d_validation_sites_Uniformly_distributed.snp.sites.vcf".format(AFSnps.numSites)
    ...
    AFIndels.out = qscript.outputDir + "/"+"ALL.wgs.%d_validation_sites_AF_distributed.indels.sites.vcf".format(AFSnps.numSites)
    ...
    UIndels.out = qscript.outputDir + "/"+"ALL.wgs.%d_validation_sites_Uniformly_distributed.indels.sites.vcf".format(AFSnps.numSites)
